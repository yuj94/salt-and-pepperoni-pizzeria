...
VALUES ('Pepperoni Pizza', 'Starting with our signature pizza sauce, adding on real cheese made from mozzarella, and finishing off with pepperoni, this is one of our most popular pizzas.', 14.50, 'Dough', 'Tomato Base', 'Mozzarella', 'Pepperoni'),
       ('Sausage Pizza', 'Starting with our signature pizza sauce, adding on real cheese made from mozzarella, and finishing off with sausage, this is our clasic Italian sausage pizza.', 14.50, 'Dough', 'Tomato Base', 'Mozzarella', 'Spicy Italian Sausage');

INSERT INTO pizza (pizza_name, pizza_description, price, ingredient_1, ingredient_2, ingredient_3)
VALUES ('3-Cheese Pizza', 'Our base pizza with rich tomato sauce base and a delightful 3-cheese blend.', 14.50, 'Dough', 'Tomato Base', '3-Cheese Blend');
...
CREATE TABLE custom_pizza (
	...
	CONSTRAINT FK_custom_pizza_ing_1 FOREIGN KEY (ingredient_1) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_2 FOREIGN KEY (ingredient_2) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_3 FOREIGN KEY (ingredient_3) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_4 FOREIGN KEY (ingredient_4) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_5 FOREIGN KEY (ingredient_5) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_6 FOREIGN KEY (ingredient_6) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_7 FOREIGN KEY (ingredient_7) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_8 FOREIGN KEY (ingredient_8) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_9 FOREIGN KEY (ingredient_9) REFERENCES ingredient(ingredient_name),
	CONSTRAINT FK_custom_pizza_ing_10 FOREIGN KEY (ingredient_10) REFERENCES ingredient(ingredient_name)
);
