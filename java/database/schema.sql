...
VALUES ('Pepperoni Pizza', 'This is one of our most popular pizzas: starting with our signature pizza sauce, adding on real cheese made from mozzarella, and finishing off with pepperoni', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/pepperoni-slate-compressed.png'),
       ('Sausage Pizza', 'Our classic Italian pizza. Fresh dough layered with sausage and real cheese made from mozzarella', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/sausage-slate-compressed.png'),
       ...
       ('Fresh Spinach & Tomato Alfredo Pizza', 'Crafted with fresh cream, Parmesan cheese and Romano cheese. This pizza is topped with fresh baby spinach, fresh-cut Roma tomatoes, sun-dried tomatoes, crisp green peppers, mushrooms, ripe black olives, plus classic Italian seasoning for an extra dash of flavor', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/fresh-spinach-tomato-compressed.png'),
       ('The Meats Pizza', 'A dream come true for meat lovers. We start with a tomato base, pack on all of the hearty meats (pepperoni, sweet sausage, spicy Italian sausage, salami, and meatballs), and top it off with onions and black olives', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/the-meats-slate-compressed.png'),
       ('Zesty Italian Trio Pizza', 'A tasty trio of zesty Italian sausage, salami, and pepperoni on our original fresh dough. Banana peppers, green olives, and a three-cheese blend are an added bonus', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/zesty-italian-trio-slate-compressed.png'),
       ('Garden Fresh Pizza', 'All of your favorite veggies together on a delightfully delicious pizza. Loaded with crisp green peppers, fresh-cut onions, mushrooms, ripe black and green olives, vine-ripened Roma tomatoes, and real cheese made from mozzarella', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/garden-fresh-slate-compressed.png'),
       ...
       ('BBQ Chicken Bacon Ranch Pizza', 'We had you at bacon, right? It gets even better. A ranch dressing base with a smoky Southern-style BBQ sauce. Add a tangy twist to this irresistible pizza topped with grilled chicken, hickory-smoked bacon, fresh-cut onions, and real cheese made from mozzarella. Round one up today', 'Pizza', 'https://www.papajohns.com/static-assets/a/images/compressed/product/pizzas/bbq-chicken-bacon-slate-compressed.png'),
...
VALUES ('Antipasto', 'Fresh mozzarella, oven roasted sweet red peppers, genoa salami, Kalamata olives, green Sicilian olives, drizzle of extra virgin olive oil, basil leaf garnish & bread', 'Appetizer', 13, 'https://d1ouk4tp1vcuss.cloudfront.net/s3.amazonaws.com/ODNUploads/61b4240dc2b7eContent_ContentFile_mobile_Antipasto_1170.png_companyCode_GRPI001_designId_1'),
       ...
       ('Root Beer', '2 Liter', 'Drink', 3, 'https://m.media-amazon.com/images/I/71nOtozS0yL._SL1500_.jpg'),
...
CREATE TABLE orders (
        ...
        credit_card_number decimal(16, 0) CHECK (credit_card_number >= 1000000000000000) DEFAULT 1000000000000000,
        credit_card_exp_month decimal(2, 0) CHECK (credit_card_exp_month >= 1 AND credit_card_exp_month <= 12) DEFAULT 01,
        credit_card_exp_year decimal(2, 0) CHECK (credit_card_exp_year >= 22 AND credit_card_exp_year <= 30) DEFAULT 22,
        credit_card_ccv decimal(4, 0) DEFAULT 1000,
