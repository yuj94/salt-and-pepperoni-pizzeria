...
CREATE TABLE orders (
        ...
        address_line_1 varchar(64) DEFAULT '0',
        address_state varchar(2) DEFAULT '0',
        address_city varchar(64) DEFAULT '0',
        address_zip_code decimal(5, 0) DEFAULT 00001,
        ...
        credit_card_exp_year decimal(2, 0) CHECK (credit_card_exp_year >= 20 AND credit_card_exp_year <= 30) DEFAULT 20,
