...
CREATE TABLE orders (
        ...
        credit_card_number decimal(16, 0) CHECK (credit_card_number > 1000000000000000),
        credit_card_exp_month decimal(2, 0) CHECK (credit_card_exp_month >= 1 AND credit_card_exp_month <= 12),
        credit_card_exp_year decimal(2, 0) CHECK (credit_card_exp_year >= 20 AND credit_card_exp_year <= 30),
        credit_card_ccv decimal(4, 0),
